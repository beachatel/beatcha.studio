...
function setup() {
  ...
  translateLabel.position(
    translateSlider.x + translateSlider.width + 20,
    translateSlider.y,
  );
  ...
  gridSizeLabel.position(
    gridSizeSlider.x + gridSizeSlider.width + 20,
    gridSizeSlider.y,
  );
  ...
  gridSizeMultLabel.position(
    gridSizeMultSlider.x + gridSizeMultSlider.width + 20,
    gridSizeMultSlider.y,
  );
